    ...
    themeConfig: {
      ...
      locales: {
        ...
        '/zh/': {
          ...
          sidebar: {
            '/zh/guide/': ['', 'get_started','install','troubleshooting', 'debug-fuse', 'faq'],
            '/zh/samples/': ['','accelerate_pvc','machinelearning','data_warmup','accelerate_hdfs',
                  ...
                  'dataset_auto_scaling.md', 'dataset_cron_scaling.md', 'monitoring.md', 'pod_schedule_global.md',
                  'multi_dataset_same_node_accessing','nonroot_access','tieredstore_config','use_encryptoptions',
                  'fuse_recover', 'juicefs_runtime', 'juicefs_for_s3', 'knative', 'application_controller', 'gcs_configuration',
                  's3_configuration'],
